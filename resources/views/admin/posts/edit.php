...
<!-- Section form -->
@start('form')
<form action="{{ aurl('posts/update') }}" method="POST" enctype="multipart/form-data">
   <div class="row">
      <div class="col-md-9">
         <div class="card mb-3">
            <div class="card-body">
                     ...
                     @foreach($categories as $category)
                        <div class="d-flex mb-1">
                           <input
                              ...
                              value="{{ $category['id'] }}"
                              class="me-2"
                              {{ ($category['id'] == $post['category_id']) ? 'checked' : '' }}
                           />
   ...
   <div class="d-flex flex-row-reverse mt-4 mb-2">
      <button type="button" class="main-btn ms-2" style="background: #6c757d">
         <a href="{{ aurl('posts') }}" style="color: #fff">{{ trans('admin.cancel') }}</a>
      </button>
